...
- Build verification policy: use the Xcode MCP tools (`BuildProject`, navigator issues) for project build checks instead of relying only on `swift build`/`swift test` CLI output.
